...
//           className={`p-4 h-full flex flex-col justify-start items-stretch min-h-0 overflow-hidden ${HEIGHT_CLASS[height]}`}
//         >
//           {children}
//         </CardContent>
//       </Card>
  ...
  return (
    <div className={WIDTH_CLASS[width]}>
      <Card>
        ...
        <CardContent
          className={`h-full flex flex-col justify-start items-start overflow-hidden overflow-x-auto ${HEIGHT_CLASS[height]}`}
        >
          {children}
        </CardContent>
      </Card>
