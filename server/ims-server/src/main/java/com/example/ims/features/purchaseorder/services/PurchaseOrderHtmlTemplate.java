...
public class PurchaseOrderHtmlTemplate {
    ...
    /**
     * CSS2 레거시 호환에 맞춰 flex 관련 스타일을 제거
     * @param c - PDF 생성에 필요한 콘텐츠 DTO
     * @return - 발주서 HTML 출력물
     */
    public static String render(PurchaseOrderPdfContent c) {
        ...
        <head>
          ...
          <style>
            ...
            body { font-family: "NanumGothic", sans-serif; font-size: 12px; color: #111; }
        ...
        <table class="mt-12">
          <thead>
            <tr>
              <th style="width:40px;">상품ID</th>
              <th style="width:90px;">상품명</th>
              <th style="width:80px;">주종</th>
